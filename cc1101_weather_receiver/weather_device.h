...
struct WeatherDevice {
  ...
  bool is_active;  // Determines whether the receiver listens for a transmitter
                  // with this ID.
  bool is_synchronized;  // Indicates whether the receiver is tracking this
                        // device's transmissions, i.e. whether the next
                        // packet's channel and time of arrival are known.
  ...
  // PacketStats for this id
  uint16_t packets_received;
  uint16_t packets_missed;
  uint16_t num_resyncs;
